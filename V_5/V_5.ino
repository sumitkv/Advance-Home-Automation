// This code has been written and developed by SUMIT KANT VERMA.
...
void manual_relay(){ 
  ...
  if(pushed1 == HIGH){
    ...
    if (EEPROM.read(0)==1){
      EEPROM.write(0,0);
      EEPROM.commit();
      Serial.println("eeprom state for relay1 is 0 ");
    }   
      }
   else{
    ...
    if (EEPROM.read(0)==0){
      EEPROM.write(0,1);
      EEPROM.commit();
      Serial.println("eeprom state for relay1 is 1 ");
    }
      } 
  ...
  if(pushed2 == HIGH){
    ...
    if (EEPROM.read(1)==1){
      EEPROM.write(1,0);
      EEPROM.commit();
      Serial.println("eeprom state for relay2 is 0 ");
    }
    ...
    if (EEPROM.read(1)==0){
      EEPROM.write(1,1);
      EEPROM.commit();
      Serial.println("eeprom state for relay2 is 1 ");
    }
      }
  ...
  if(pushed3 == HIGH){
    ...
    if (EEPROM.read(2)==1){
      EEPROM.write(2,0);
      EEPROM.commit();
      Serial.println("eeprom state for relay3 is 0 ");
    }  
      }
   else{
    ...
    if (EEPROM.read(2)==0){
      EEPROM.write(2,1);
      EEPROM.commit();
      Serial.println("eeprom state for relay3 is 1 ");
    }
      }
  ...
  if(pushed4 == HIGH){
    ...
    if (EEPROM.read(3)==1){
      EEPROM.write(3,0);
      EEPROM.commit();
      Serial.println("eeprom state for relay4 is 0 ");
    }  
      }
   else{
    ...
    if (EEPROM.read(3)==0){
      EEPROM.write(3,1);
      EEPROM.commit();
      Serial.println("eeprom state for relay4 is 1 ");
    }
      }
    }
  }
